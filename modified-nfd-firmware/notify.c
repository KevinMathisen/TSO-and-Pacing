 ...
 * TODO: need to dequeue based on current time
 */
__intrinsic void
...
do {                                                                         \
    ...
    if (batch_in.pkt##_pkt##.eop) {                                          \
        ...
        pacing_rate = (vlan_field & 0x0FFF)*25; /* 500ns -> 20ns ticks */    \
        ...
        for (;;) {                                                           \
            ...
            if (lso_pkt.desc.lso == NFD_IN_ISSUED_DESC_LSO_RET) {            \
                ...
                update_departure_time(flow_id, dep_time-pacing_rate);        \
                                                                             \
